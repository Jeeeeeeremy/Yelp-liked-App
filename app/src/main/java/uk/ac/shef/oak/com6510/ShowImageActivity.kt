...
class ShowImageActivity : AppCompatActivity() {
    ...
    private fun displayData(position: Int){
        if (position != -1) {
            ...
            descriptionTextView.text = "title:"+MyAdapter.items[position].imageTitle+"\ndescription:"+MyAdapter.items[position].imageDescription+"\nlatitude:"+MyAdapter.items[position].latitude+"\nlongitude:"+MyAdapter.items[position].longitude+"\ntemperature:"+MyAdapter.items[position].temperature+"\npressure:"+MyAdapter.items[position].pressure
